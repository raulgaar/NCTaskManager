...
public class ArrayTaskListImpl /*extends AbstractTaskList*/ implements ArrayTaskList {
...
*/
    ...
    public boolean equals(Object o) {
        ...
        return (arrayTaskList.size() == this.size());
    }

    @Override
    public int hashCode() {
        ArrayTaskListImpl id = this;
        return id.hashCode();
    }

    @Override
    public ArrayTaskList clone() {
        ArrayTaskList cloneList = null;
        try {
            cloneList = (ArrayTaskList) super.clone();
